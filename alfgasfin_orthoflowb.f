C WARNING: ~THIS CODE IS PURELY TO ALLOW IDENTIFICATIONS OF THE REGIONS WHERE IONIZATION TAKES PLACE
c iN ALFVEN IONIZATION, IT IS UNPHYSICAL DO NOT USE.
...
C work out the constant for the adiabatic law
	...
	PRINT*, 'WARNING: This code is purely for visualisation, 
...
C These lines are commented out, the density is not changed but the velocity is still
C Extracted, this is to visualise the locations at which the ionization takes place.
C	   ee(l,m,1) =  ee(l,m,1) + ioni

C           dd(l,m,1) =  dd(l,m,1) - ioni
